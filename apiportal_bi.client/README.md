...
The Portal Guide is self-contained and does not require a database or successful `/api` response to render. ASP.NET Core remains the host, health endpoint and future narrow Portal API boundary.
